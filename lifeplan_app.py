...
with st.sidebar:
    ...
    # Campi alternativi: casa già posseduta oppure casa da acquistare.
    ...
    if owns_home_initially:
        ...
        owned_mortgage_payment = st.number_input(
            ...
            disabled=(owned_home_financing != "Con mutuo in corso"),
        )
        ...
        st.caption(
            "Se possiedi già la casa, gli scenari di nuovo acquisto vengono esclusi automaticamente."
        )
    else:
        house_price = st.number_input(
            ...
            step=5000.0,
            help=(
                "Prezzo espresso nell'anno iniziale della simulazione. "
                "Se l'acquisto è ritardato, il prezzo viene rivalutato fino all'anno effettivo."
            ),
        )
    ...
    maintenance_reference_value = owned_home_value if owns_home_initially else house_price
